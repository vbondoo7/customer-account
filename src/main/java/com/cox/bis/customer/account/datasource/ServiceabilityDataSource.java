package com.cox.bis.customer.account.datasource;
...
@Component
@ConfigurationProperties("datasource.serviceability") 
public class ServiceabilityDataSource {
